...
<a href="{{ route('jenis-penyaluran.create') }}" class="bg-biru text-white py-1 px-3 rounded-md text-sm transition-all duration-150 ease-in-out hover:bg-sky-700">
    ...
    <table class="w-full bg-white border border-gray-200">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                    <!-- button edit -->
                    <a href="{{ route('jenis-penyaluran.edit', $penyaluran->kode_jenis) }}" class="bg-green-500 text-white py-1 px-3 rounded-md mb-1 transition-all duration-150 ease-in-out hover:bg-green-700">
                        <ion-icon name="create-outline"></ion-icon>
                    </a>
                    <!-- a delete -->
                    <form action="{{ route('jenis-penyaluran.destroy', $penyaluran->kode_jenis) }}" method="POST" class="mt-2" onsubmit="return confirm('Are you sure you want to delete this user?');">
@csrf
@method('DELETE')
