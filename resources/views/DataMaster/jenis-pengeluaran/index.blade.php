...
<a href="{{ route('jenis-pengeluaran.create') }}" class="bg-biru text-white py-1 px-3 rounded-md text-sm transition-all duration-150 ease-in-out hover:bg-sky-700">
...
<form action="{{ route('jenis-pengeluaran.index') }}" method="GET" class="relative mt-1 flex items-center">
    ...
    <table class="w-full bg-white border border-gray-200">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                    <!-- button edit -->
                    <a href="{{ route('jenis-pengeluaran.edit', $pengeluaran->kode_jenis) }}" class="bg-green-500 text-white py-1 px-3 rounded-md mb-1 transition-all duration-150 ease-in-out hover:bg-green-700">
