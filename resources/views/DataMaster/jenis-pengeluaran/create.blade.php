<x-layout>
    ...
    <div class="bg-base-100 w-full rounded-lg shadow capitalize">
      ...
      <div class="w-full p-4">
        <form class="needs-validation peer grid gap-y-4" novalidate action="{{ route('jenis-pengeluaran.store') }}" method="POST">
        @csrf
          <!-- Account Details -->
          <div class="w-full">
            <h6 class="text-lg font-semibold">Add Data jenis pengeluaran</h6>
            <hr class="mb-4 mt-2" />
          </div>
