<x-layout>
    <div class="p-4">
        ...
        <div class="flex items-center justify-between mt-4 ">
            <form method="GET" action="{{ route('muzakki.export') }}" class="flex items-center">
        ...
        <div class="flex items-center justify-between mt-4 text-sm">
            ...
            <form action="{{ route('muzakki.index') }}" method="GET" class="relative mt-1 flex items-center">
                    ...
                    @foreach ($muzakki as $index => $pemberi)
                        <tr>
                            ...
                            <td class="px-6 py-4 border-b border-gray-200 bg-white text-sm">
                                ...
                                <!-- a delete -->
                                <form action="{{ route('muzakki.destroy', $pemberi->id) }}" method="POST"
                                    class="mt-2"
